...
class UNetMobileNet(nn.Module):
    ...
    def forward(self, x):
        ...
        dec1 = self.upconv1(enc5)      # [batch, 320, 8, 8]
        ...
        dec2 = self.upconv2(dec1)      # [batch, 160, 16, 16]
        ...
        dec3 = self.upconv3(dec2)      # [batch, 64, 32, 32]
        ...
        dec4 = self.upconv4(dec3)      # [batch, 32, 64, 64]
        ...
        dec5 = self.upconv5(dec4)      # [batch, 16, 128, 128]
